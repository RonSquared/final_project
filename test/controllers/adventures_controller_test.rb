...
class AdventuresControllerTest < ActionController::TestCase
  ...
  test "should create adventure" do
    assert_difference('Adventure.count') do
      post :create, adventure: { activity: @adventure.activity, date: @adventure.date, duration: @adventure.duration, maps: @adventure.maps, misc_notes: @adventure.misc_notes }
    end
  ...
  test "should update adventure" do
    patch :update, id: @adventure, adventure: { activity: @adventure.activity, date: @adventure.date, duration: @adventure.duration, maps: @adventure.maps, misc_notes: @adventure.misc_notes }
    assert_redirected_to adventure_path(assigns(:adventure))
  end
